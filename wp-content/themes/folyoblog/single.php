...
<a class="addthis_button" tw:via="YoFolyo" href="http://www.addthis.com/bookmark.php?v=250&amp;pubid=ra-500bbc997c97bee3"><img src="http://s7.addthis.com/static/btn/v2/lg-share-en.gif" width="125" height="16" alt="Bookmark and Share" style="border:0"/></a>
<script type="text/javascript" src="http://s7.addthis.com/js/250/addthis_widget.js#pubid=ra-500bbc997c97bee3"></script>
<!-- AddThis Button END -->
				<!-- 			<div class="twitter">
